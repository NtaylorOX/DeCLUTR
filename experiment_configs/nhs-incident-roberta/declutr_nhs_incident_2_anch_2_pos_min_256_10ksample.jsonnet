...
local transformer_model = "E:/saved_models/transformers/roberta-base-NHS-incidents/sampled_250000/16-09-2022--12-57/checkpoint-50000";
...

{
    ...
    "train_data_path": "E:/working_incident_data/cleaned_data/declutr_lm/sample_10000/min_256/train.txt",    
    "model": {
        "type": "declutr",
        "text_field_embedder": {
            "type": "mlm",
